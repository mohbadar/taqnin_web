...
@Component({
  selector: 'app-manage-subject-order',
  templateUrl: './manage-subject-order.component.html',
  styleUrls: ['./manage-subject-order.component.scss']
})
export class ManageSubjectOrderComponent implements OnInit {
