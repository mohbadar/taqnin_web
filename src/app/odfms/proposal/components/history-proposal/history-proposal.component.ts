...
@Component({
  selector: 'app-history-proposal',
  templateUrl: './history-proposal.component.html',
  styleUrls: ['./history-proposal.component.scss']
})
...
loading;
  ...
  ngOnInit(): void {
    ...
    this.proposalService.getProposalLog(this.data).subscribe(res=>{
