...
@Component({
  selector: 'app-followup-proposal',
  templateUrl: './followup-proposal.component.html',
  styleUrls: ['./followup-proposal.component.scss']
})
export class FollowUpProposalComponent implements OnInit {
  @Input() data;
  allComments;
  createdAt;
  ...
  ngOnInit(): void {
    console.log("follow up proposal id : ", this.data);
