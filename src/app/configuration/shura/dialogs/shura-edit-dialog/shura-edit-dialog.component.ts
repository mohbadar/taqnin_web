...
@Component({
	selector: 'shura-edit-dialog',
	templateUrl: './shura-edit-dialog.component.html',
	styleUrls: ['./shura-edit-dialog.component.scss']
})
export class ShuraEditDialogComponent implements OnInit {
