...
export var lineChartData: Array<any> = [
  ...
  export var ploarChartColors: any[] = [{ backgroundColor: ['#975AFF', '#F77E17', '#40C057', '#F55252', '#2F8BE6','#A10A28','#C7B42C','#AAAAAA','#5AA454','#42f566','#f5d442',' #b88365','#65b7b8','#ebb5e9','#f74a98','#178252','#c96969','#30700b'] }];
